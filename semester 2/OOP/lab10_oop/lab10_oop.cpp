...
int lab10_oop::getSelectedIndex() const
{
	QModelIndexList selectedIndexes = this->ui.plantsListWidget->selectionModel()->selectedIndexes();
	if (selectedIndexes.size() == 0)
	{
		this->ui.codedNameLineEdit->clear();
		this->ui.speciesLineEdit->clear();
		this->ui.ageInMonthsLineEdit->clear();
