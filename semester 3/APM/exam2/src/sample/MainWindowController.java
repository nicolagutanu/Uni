        ...
        EventHandler<MouseEvent> eventHandlerForPrgStateList= new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                try {
                    ...
                    PrgState prg=new PrgState(new MyStack<>(), new MyDictionary<String, Value>(), new MyHeap<Value>(), new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), new MyBarrier<Integer, Pair<Integer, List<Integer>>>(),selectedStmt);
