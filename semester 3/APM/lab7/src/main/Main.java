...
public class Main {
    ...
    public static void main(String[] args) throws AdtException, MyException {
        ...
        try{
            ...
            PrgState prg14=new PrgState(stack14, new MyDictionary<String, Value>(), new MyHeap<Value>(), new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), ex14);
        ...
        try{
            ...
            PrgState prg15=new PrgState(stack15, new MyDictionary<String, Value>(), new MyHeap<Value>(), new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), ex15);
        ...
        try{
            ...
            PrgState prg16=new PrgState(stack16, new MyDictionary<String, Value>(), new MyHeap<Value>(), new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), ex16);
        ...
        try{
            ...
            PrgState prg17=new PrgState(stack17, new MyDictionary<String, Value>(), new MyHeap<Value>(), new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), ex17);
        ...
        try{
            ...
            PrgState prg18=new PrgState(stack18, new MyDictionary<String, Value>(), new MyHeap<Value>(), new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), ex18);
        ...
        try{
            ...
            PrgState prg19=new PrgState(stack19, new MyDictionary<String, Value>(), new MyHeap<Value>(), new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), ex19);
        ...
        try{
            ...
            PrgState prg20=new PrgState(stack20, new MyDictionary<String, Value>(), new MyHeap<Value>(), new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), ex20);
