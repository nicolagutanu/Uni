...
public class PrgState {
    ...
    IBarrier<Integer,BarrierPair> barrierTable;
    IStatement originalPrg;
    Integer id;
    static Integer counter=0;
    static Integer next=1;
    ...
    public PrgState(IStack<IStatement> eStk, IDictionary<String, Value> sTab,  IHeap<Value> h, IList<Value> o, IDictionary<StringValue, BufferedReader> fT, IBarrier<Integer,BarrierPair> barrierTbl, IStatement ogPrg){
        id=counter++;
        exeStack=eStk;
        symTable=sTab;
        heap=h;
    ...
    public IBarrier<Integer,BarrierPair> getBarrierTable() { return barrierTable; }
    public IStatement getOriginalPrg() { return originalPrg; }
    public Integer getId() { return id; }

    public Integer getNewFreeLocation() { return next++; }
    ...
    public void setBarrierTable(IBarrier<Integer,BarrierPair> barrierTbl) { barrierTable=barrierTbl; }
