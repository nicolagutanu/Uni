...
public class MainWindowController {
    ...
    public void populate() {
        ...
        //do barrier ex, test it, something probably doesn't work

        statementList=new ArrayList<>(Arrays.asList(ex1,ex2,ex3,ex4,ex5,ex6,ex7,ex8,ex9,ex10,ex11,ex12,ex13,ex14));
        ObservableList<IStatement> prgStates=FXCollections.observableArrayList(ex1,ex2,ex3,ex4,ex5,ex6,ex7,ex8,ex9,ex10,ex11,ex12,ex13,ex14);
