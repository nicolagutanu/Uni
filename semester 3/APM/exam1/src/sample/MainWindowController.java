...
public class MainWindowController {
    ...
    public void populate() {
        ...
        IStatement ex2=new CompStmt(new VarDeclStmt("v",new IntType()),
                new CompStmt(new VarDeclStmt("x", new IntType()),
                        new CompStmt(new VarDeclStmt("y",new IntType()),
                                new CompStmt(new AssignStmt("v",new ValueExp(new IntValue(0))),
                                        new CompStmt(new RepeatStmt(new CompStmt(new ForkStmt(
                                                new CompStmt(new PrintStmt(new VarExp("v")),new AssignStmt("v",new ArithExp('-',new VarExp("v"),new ValueExp(new IntValue(1)))))),new AssignStmt("v",new ArithExp('+',new VarExp("v"),new ValueExp(new IntValue(1))))),
                                                new RelationalExp(3,new VarExp("v"),new ValueExp(new IntValue(3)))),
        ...
        statementList=new ArrayList<>(Arrays.asList(ex1,ex2));
        ObservableList<IStatement> prgStates=FXCollections.observableArrayList(ex1,ex2);
