...
public class UI {
    ...
    public void fileRepo(){
        FileRepositoryMovie repositoryMovie = new FileRepositoryMovie();
        FileRepositoryCinema repositoryCinema = new FileRepositoryCinema();
        FileRepositoryGenre repositoryGenre = new FileRepositoryGenre();
        FileRepositoryCatalog repositoryCatalog = new FileRepositoryCatalog();
        FileRepositoryTicket repositoryTicket = new FileRepositoryTicket();
        serviceMovie=new ServiceMovie(repositoryMovie, repositoryCinema, repositoryGenre, repositoryCatalog, repositoryTicket, new MovieValidator());
        serviceCinema=new ServiceCinema(repositoryCinema, new CinemaValidator());
        serviceGenre=new ServiceGenre(repositoryGenre, new GenreValidator());
        serviceCatalog=new ServiceCatalog(repositoryCatalog, new CatalogValidator());
