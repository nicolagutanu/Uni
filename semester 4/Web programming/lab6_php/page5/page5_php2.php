...
echo '<th style="border: 1px solid black;font-size: 20px;">Type</th>';
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo '<td style="border: 1px solid black;font-size: 20px;">'.$row["Type"].'</td>';
